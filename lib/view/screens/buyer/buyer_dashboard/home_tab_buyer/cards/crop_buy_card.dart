...
class CropSellCardBuyer extends StatelessWidget {
  final BuildContext ctx;
  final CropBuyDataBuyer data;

  const CropSellCardBuyer({Key? key, required this.ctx, required this.data})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(ctx, RoutePaths.sendOfferToFarmer,
          arguments: {"data": data}),
      child: Container(
        color: Colors.white,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      TextHelper.textWithColorSize("BUY CROP", 14, Colors.blue , fontWeight: FontWeight.w500)
                    ],
                  )
                ],
              ),
