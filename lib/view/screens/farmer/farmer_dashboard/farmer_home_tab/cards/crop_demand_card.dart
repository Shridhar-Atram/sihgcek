...
class CropDemandCardFarmer extends StatelessWidget {
  final BuildContext ctx;
  final DemandCropDataFarmer data;
  const CropDemandCardFarmer({Key? key , required this.ctx, required this.data}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(ctx, RoutePaths.sendOfferToBuyer , arguments: {"data" : data}),
      child: Container(
        color: Colors.white,
