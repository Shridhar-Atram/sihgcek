...
class CropDemandCardForRecentFarmer extends StatelessWidget {
  final BuildContext ctx;
  final RecentBidDataFarmer data;
  const CropDemandCardForRecentFarmer({Key? key , required this.ctx, required this.data}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 5,),
          TextHelper.textWithColorSize("Offer by you :  "+   data.offerperUnitAsked.toString() + " Rs", 15 , Colors.black),
          ...
          const SizedBox(height: 5,),
          TextHelper.textWithColorSize("Quantity you asked:  " + data.quantityAsked.toString()+" Kg", 15, Colors.black),
          const SizedBox(height: 5,),
          Container(
