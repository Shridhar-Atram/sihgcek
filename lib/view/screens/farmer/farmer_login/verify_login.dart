...
class VerifyFarmerLogin extends StatefulWidget {
  const VerifyFarmerLogin({Key? key}) : super(key: key);

  @override
  _VerifyFarmerLoginState createState() => _VerifyFarmerLoginState();
}

class _VerifyFarmerLoginState extends State<VerifyFarmerLogin> {
  @override
                  ...
                  Container(
                    ...
                    child: ButtonHelper.getElevatedButton("Verify OTP", () {
                      loginController.verifyPhoneNumber(
                          context, prevVal!["vid"], optCtrl.text , prevVal!["phone"] , prevVal!["farmerID"]);
                    }),
                  ),
                ],
              ),
