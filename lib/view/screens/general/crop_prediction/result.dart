...
class _AddCropScreenFarmerState extends State<ResultScreen> {
  @override
        ...
        child: Center(
            child: Column(
              ...
              children: [
                ...
                Container(
                  child: TextHelper.textWithColorSize("Recommended Crop is ", 20, Colors.black , fontWeight: FontWeight.w400),
                ),
                Container(
